...
URL Conf가 설정되지 않은 상태. 띠리서 reverse를 사용할 수 없음
"""
...
#소셜로그인 사용한 클라이언트가 이동할 주소를 저장하는 용도
...
SECRET_KEY = '+9zre3ftxob=b2ut^m*=m@b(gp+vp*jn9i7i=4wy7j4ih09cic'

# SECURITY WARNING: don't run with debug turned on in production!
#개발이 끝나면 DEBUG 변수에 False 값을 저장해
#에러코드를 숨김
DEBUG = False
#도메인주소(127.0.0.1:8000)만 웹서버에 접속할수있도록
#설정하는 변수
#웹클라이언트는 127.0.0.1.이나 XXX(회원이름).pythonanywhere.com
#으로 시작하는 웹주소만 웹서버에 접속할 수 있음
...
SOCIAL_AUTH_GOOGLE_PLUS_KEY= '55901786523-kujnbu7l6lt934c4ol8inojlccrro5ku.apps.googleusercontent.com'
SOCIAL_AUTH_GOOGLE_PLUS_SECRET = 'tgTssns99v2uRcVZY1bxI7d3'
