...
#bookmark 폴더에 있는 view.py의 뷰함수 임포트
from bookmark.views import index,book_list,book_one

#urls.py : 웹클라이언트의 요청을 분석해 특정한 뷰를 호출하는
