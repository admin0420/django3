...
model : MTV 패턴중 하나로 데이터베이스에 데이저를 저장할
...
2)정의한 모델 클래스를 makemigrations 명령으로  migrations 폴더에
 migration 파일 저장
...
class Bookmark(models.Model):
    #모델 클래스에서 저장할 변수는 클래스 변수로 정의함
    #클래스변수에 models.XXXXFields 클래스의 객체를 저장하는 것으로
    #저장공간 정의
