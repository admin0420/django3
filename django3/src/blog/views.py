...
from blog.models import Post, PostImpage, PostFile
...
#LoginRequiredMixin : 사용자가 비로그인 상태로 이 뷰를 요청할
...
class Posting(LoginRequiredMixin ,FormView):
    ...
    def form_valid(self, form):
        ...
        #사용자가 넘겨준 이미지파일 마다 PostImage객체 생성
